        ...
        try {
            ...
            const completion = await openai.chat.completions.create({
                ...
                messages: [
                    ...
                    {
                        "role": "user",
                        "content": `Проаналізуй цей спіч: ${speech}. Оціни його за такими критеріями: вправне формулювання тези, структурованість, послідовність і логічність висловлення думок, вагомість аргументів, дотримання теми, наявність доказів аргументів (приклади з життя, літератури і тд). На останньому окремому рядку визнач та напиши досвід гри в дебати користувача: Немає досвіду, Пів року, 1 рік, 1,5 і більше року.`
                    }
                ]
            });
